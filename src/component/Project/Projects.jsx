...
const data = [
    { title: 'Web Development', description: `it's a weather app,utilize this app to know your living city's or any other city's weather that u wanna know the weather`, imgURL: images.js01, cat: 'javascript', link: 'https://yawai990.github.io/weatherapp/', code: 'https://github.com/yawai990/weatherapp' },
    { title: 'Web Development', description: 'it\'s is a tiny e-commerce app,you can try like a real e-commerce', imgURL: images.react01, cat: 'react', link: 'https://shopmm.netlify.app/', code: 'https://github.com/yawai990/e-commerce' },
